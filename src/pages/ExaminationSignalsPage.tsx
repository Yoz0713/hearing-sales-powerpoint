...
const TRUST: ExamSignalsSpec = {
  ...
  intro: '客戶記不住每一個數字，卻會記得整段檢查被怎麼對待',
  ...
  themes: [
    {
      ...
      moves: [
        { act: '檢測前先說聽力都沒問題的話，檢查大概10分鐘', detail: '「先給客人一個印象，是檢查時間取決於聽力程度」' },
        { act: '過程中說檢查會比預期多', detail: '讓客戶檢查都還沒做完就提前做好心理準備，聽力已經到了一個程度' },
      ],
    },
    {
      name: '傳達認真',
      ...
      moves: [
        ...
        { act: '把輕鬆的氣氛慢慢轉向沉重', detail: '該嚴肅的時候，就讓它嚴肅' },
      ],
    },
    {
      name: '回到生活',
      ...
      moves: [
        ...
        { act: '再次詢問客戶日常生活中的COSI', detail: '像看電視、講電話的時候' },
      ],
    },
  ],
